...
class Article < ActiveRecord::Base
  attr_accessible :title, :body, :released_at, :expired_at, :member_only, :no_expiration#アクセス権の設定
  validates :title, :body, :released_at, presence: true					#空の値禁止
  validates :title, length: {maximum: 200}						#文字の長さ
